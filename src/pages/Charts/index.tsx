...
const config = {
  ...
  drawResult: (ctx: any, data: { xAxisVal: any; yAxisVal: number; }, chartParameter: { dpi: any; chartRect: any; }) => {
...
//     color: '#ACB1C0'
//   },
//   xAxisFormat: (val: string) => {
//     return val.substr(-5).replace('-', '/');
//   },
//   resultFormat: (data: { yAxisVal: number; }) => {
...
const Charts = () => {
  ...
  React.useEffect(() => {
    const chart = new Area(document.querySelector('.chart') as HTMLElement, config as any);
